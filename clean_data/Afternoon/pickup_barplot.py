...
p1 = pd.read_csv("pickup-2019-01.csv")
p2 = pd.read_csv("pickup-2019-02.csv")
p3 = pd.read_csv("pickup-2019-03.csv")
p4 = pd.read_csv("pickup-2019-04.csv")
p5 = pd.read_csv("pickup-2019-05.csv")
p6 = pd.read_csv("pickup-2019-06.csv")
...
p_all=p_all[["PULocationID", "Half Year Sum", "01", "02", "03", "04","05", "06"]]
...
plt.title("Afternoon (11am-4pm) Pickups at Different Locations (2019 Jan. to Jun.)")
